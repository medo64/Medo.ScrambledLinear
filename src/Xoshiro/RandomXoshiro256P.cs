...
namespace ScrambledLinear {
    ...
    public class RandomXoshiro256P {
        ...
        /// </summary>
        public RandomXoshiro256P() {
            Algorithm = new Xoshiro256P();
        }
        ...
        public RandomXoshiro256P(int seed) {
            Algorithm = new Xoshiro256P(seed);
        }

        private readonly Xoshiro256P Algorithm;
