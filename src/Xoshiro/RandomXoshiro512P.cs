...
namespace ScrambledLinear {
    ...
    public class RandomXoshiro512P {
        ...
        /// </summary>
        public RandomXoshiro512P() {
            Algorithm = new Xoshiro512P();
        }
        ...
        public RandomXoshiro512P(int seed) {
            Algorithm = new Xoshiro512P(seed);
        }

        private readonly Xoshiro512P Algorithm;
