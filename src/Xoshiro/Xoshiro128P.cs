...
namespace Xoshiro {
    ...
    /// <summary>
    /// xoshiro128+
    /// 32-bit generator intended for floating point numbers with 128-bit state.
    /// </summary>
    ...
    public class Xoshiro128P {
        ...
        public double NextDouble() {
            var value = (UInt64)(NextValue() >> 4) << 36;  // throw away the lowest four bits as they fail linearity test
