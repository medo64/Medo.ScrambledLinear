...
namespace Xoshiro {
    ...
    /// <summary>
    /// xoshiro256+
    /// 64-bit generator intended for floating point numbers with 256-bit state.
    /// </summary>
    ...
    public class Xoshiro256P {
        ...
        public double NextDouble() {
            var value = (NextValue() >> 3) << 3;  // throw away the lowest three bits as they fail linearity test
