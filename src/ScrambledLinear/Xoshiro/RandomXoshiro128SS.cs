...
namespace ScrambledLinear {
    ...
    public class RandomXoshiro128SS {
        ...
        /// </summary>
        public RandomXoshiro128SS() {
            Algorithm = new Xoshiro128SS();
        }
        ...
        public RandomXoshiro128SS(int seed) {
            Algorithm = new Xoshiro128SS(seed);
        }

        private readonly Xoshiro128SS Algorithm;
