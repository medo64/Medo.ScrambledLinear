...
namespace ScrambledLinear {
    ...
    public class RandomXoshiro512SS {
        ...
        /// </summary>
        public RandomXoshiro512SS() {
            Algorithm = new Xoshiro512SS();
        }
        ...
        public RandomXoshiro512SS(int seed) {
            Algorithm = new Xoshiro512SS(seed);
        }

        private readonly Xoshiro512SS Algorithm;
