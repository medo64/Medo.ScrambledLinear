...
namespace ScrambledLinear {
    ...
    public class RandomXoshiro256PP {
        ...
        /// </summary>
        public RandomXoshiro256PP() {
            Algorithm = new Xoshiro256PP();
        }
        ...
        public RandomXoshiro256PP(int seed) {
            Algorithm = new Xoshiro256PP(seed);
        }

        private readonly Xoshiro256PP Algorithm;
