...
namespace ScrambledLinear {
    ...
    /// <summary>
    /// 32-bit random number generator intended for floating point numbers with 128-bit state (xoshiro128+).
    /// </summary>
    public class RandomXoshiro128P {
        ...
        /// </summary>
        public RandomXoshiro128P() {
            Algorithm = new Xoshiro128P();
        }
        ...
        public RandomXoshiro128P(int seed) {
            Algorithm = new Xoshiro128P(seed);
        }

        private readonly Xoshiro128P Algorithm;
        ...
        public double NextDouble() {
            var value = (UInt64)(Algorithm.Next() >> 4) << 36;  // throw away the lowest four bits as they fail linearity test
