...
namespace ScrambledLinear {
    ...
    public class RandomXoshiro512PP {
        ...
        /// </summary>
        public RandomXoshiro512PP() {
            Algorithm = new Xoshiro512PP();
        }
        ...
        public RandomXoshiro512PP(int seed) {
            Algorithm = new Xoshiro512PP(seed);
        }

        private readonly Xoshiro512PP Algorithm;
