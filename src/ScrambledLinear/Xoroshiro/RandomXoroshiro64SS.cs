...
namespace ScrambledLinear {
    ...
    public class RandomXoroshiro64SS {
        ...
        /// </summary>
        public RandomXoroshiro64SS() {
            Algorithm = new Xoroshiro64SS();
        }
        ...
        public RandomXoroshiro64SS(int seed) {
            Algorithm = new Xoroshiro64SS(seed);
        }

        private readonly Xoroshiro64SS Algorithm;
