...
namespace ScrambledLinear {
    ...
    public class RandomXoroshiro1024SS {
        ...
        /// </summary>
        public RandomXoroshiro1024SS() {
            Algorithm = new Xoroshiro1024SS();
        }
        ...
        public RandomXoroshiro1024SS(int seed) {
            Algorithm = new Xoroshiro1024SS(seed);
        }

        private readonly Xoroshiro1024SS Algorithm;
