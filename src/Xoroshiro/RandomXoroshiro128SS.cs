...
public class RandomXoroshiro128SS {
    ...
    /// </summary>
    public RandomXoroshiro128SS() {
        Algorithm = new Xoroshiro128SS();
    }
    ...
    public RandomXoroshiro128SS(int seed) {
        Algorithm = new Xoroshiro128SS(seed);
    }

    private readonly Xoroshiro128SS Algorithm;
