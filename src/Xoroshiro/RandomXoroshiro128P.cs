...
public class RandomXoroshiro128P {
    ...
    /// </summary>
    public RandomXoroshiro128P() {
        Algorithm = new Xoroshiro128P();
    }
    ...
    public RandomXoroshiro128P(int seed) {
        Algorithm = new Xoroshiro128P(seed);
    }

    private readonly Xoroshiro128P Algorithm;
