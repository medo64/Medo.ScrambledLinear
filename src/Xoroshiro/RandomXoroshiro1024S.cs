...
namespace ScrambledLinear {
    ...
    public class RandomXoroshiro1024S {
        ...
        /// </summary>
        public RandomXoroshiro1024S() {
            Algorithm = new Xoroshiro1024S();
        }
        ...
        public RandomXoroshiro1024S(int seed) {
            Algorithm = new Xoroshiro1024S(seed);
        }

        private readonly Xoroshiro1024S Algorithm;
